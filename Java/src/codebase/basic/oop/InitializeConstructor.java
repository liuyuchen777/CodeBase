...
*/
class Bread {
    Bread() { System.out.println("codebase.basic.oop.Bread()"); }
}

class Cheese {
    Cheese() { System.out.println("codebase.basic.oop.Cheese()"); }
}

class Meal {
    Meal() { System.out.println("codebase.basic.oop.Meal()"); }
}

class Lunch extends Meal {
    Lunch() { System.out.println("codebase.basic.oop.Lunch()"); }
}

class PortalLunch extends Lunch {
    PortalLunch() { System.out.println("codebase.basic.oop.PortalLunch()");}
}
...
public class InitializeConstructor {
    ...
    */
    ...
    InitializeConstructor() {
        /*
            when use constructor to initialize, member variable is first setted default value of codebase.basic.type
