...
public class NumberMath {
    ...
    */
    ...
    public void typeConvertor() {
        System.out.println("---------codebase.basic.type convertor----------");
        /*
            xxxValue() -> convert number codebase.basic.type to xxx number codebase.basic.type
            byteValue()
            doubleValue()
            floatValue()
            intValue()
        ...
        */
        ...
        /*
            xxx.valueOf() -> convert other codebase.basic.type to xxx number codebase.basic.type
        */  
