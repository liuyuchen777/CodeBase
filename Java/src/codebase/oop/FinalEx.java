...
class WithFinals {
    ...
    */
    public final void f() { System.out.println(" codebase.oop.WithFinals.f() "); }
    private void g() { System.out.println(" codebase.oop.WithFinals.g() "); }
}

class OverridingPrivate extends WithFinals {
    // public final void f() { System.out.println(" codebase.oop.OverridingPrivate.f() ");} // error
    private void g() { System.out.println(" codebase.oop.OverridingPrivate.f() "); }
...
// error
// class TryToExtend extends codebase.oop.FinalClass {
