...
public class BasicStream {
    public static void main(String[] args) {
        System.out.println("------------codebase.oop.Basic Stream-----------");
         ...
         *            default result if the codebase.stream is empty
         * Accumulator – a function that takes two parameters: a partial result of the reduction
         *               operation and the next element of the codebase.stream
