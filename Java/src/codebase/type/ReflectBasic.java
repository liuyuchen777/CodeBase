...
class Apple {
    private int price = 0;
    public Apple() {
        System.out.println("I am in codebase.type.Apple Constructor!");
    }
...
public class ReflectBasic {
    public static void main(String[] args) {
        ...
        try {
            ...
            Class clz = Class.forName("codebase.container.AppleItem");
            ...
            */
            ...
            // 只能使用默认的无参构造方法
            /*
            codebase.type.Apple apple = (codebase.type.Apple)clz.newInstance()
            */
            ...
            Class clz = codebase.type.Apple.class;
